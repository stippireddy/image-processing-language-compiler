...
/**
 * 
 * A simple globalLog that can be used to record a trace of the PLPRuntime* method calls and output
 * from CodeGenUtils.genPrint and CodeGenUtils.getPrintTOS. This is required at runtime.
 * 
