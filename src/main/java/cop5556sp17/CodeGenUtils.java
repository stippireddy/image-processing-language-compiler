...
/**
 * This class contains several static methods useful when developing the code generation part of our
 * compiler.
 * 
 */
...
public class CodeGenUtils {
  ...
  /**
   * Converts the provided classfile, generally created by asm, in a human readable format and
   * returns as a String.
   * 
   * @param bytecode
   */
  ...
  /**
   * Prints the provided classfile, generally created by asm, in a human readable format
   * 
   * @param bytecode
   */
  ...
  /**
   * Creates an instance of the indicated class from the provided byteCode. args is passed as a
   * parameter to the constructor, and in order to be the correct type for generated code, should be
   * String[]
   * 
   * 
   * @param name
  ...
  /**
   * Generates code to print the value on top of the stack without consuming it. If !GEN, does not
   * generate code.
   * 
    ...
    if (GEN) {
      switch (type) {
        ...
        case BOOLEAN: {
          ...
          mv.visitInsn(Opcodes.DUP);
          mv.visitMethodInsn(Opcodes.INVOKESTATIC, "java/lang/Boolean", "toString",
