...
public class PLPRuntimeFilterOps {
  ...
  static final float[] blurKernel = {ninth, ninth, ninth, ninth, ninth, ninth, ninth, ninth, ninth};
  static final float[] sharpenKernel = {0.0f, -1.0f, 0.0f, -1.0f, 5.0f, -1.0f, 0.0f, -1.0f, 0.0f};

  /**
   * Returns blurred version of source image in dest image. If dest is null, a new BufferedImage
  ...
  public final static String opSig = "(" + PLPRuntimeImageIO.BufferedImageDesc
      + PLPRuntimeImageIO.BufferedImageDesc + ")" + PLPRuntimeImageIO.BufferedImageDesc;

  /**
   * Returns sharpened version of source image in dest image. If dest is null, a new BufferedImage
   * object is created and returned.
   * 
   * Precondition: source != dest.
   * 
  ...
  /**
   * Returns a gray scale version of source image in dest image. If dest is null, a new
   * BufferedImage object is created and returned.
   * 
   * @param image
   * @param dest
   * @return
  ...
  public static BufferedImage grayOp(BufferedImage image, BufferedImage dest) {
    ...
    if (dest == null) {
      ...
      dest = new BufferedImage(destColorModel, destColorModel.createCompatibleWritableRaster(w, h),
