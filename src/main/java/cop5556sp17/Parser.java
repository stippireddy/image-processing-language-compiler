...
public class Parser {
	...
	/**
	 * Exception to be thrown if a syntax error is detected in the input. You will want to provide a useful error
	 * message.
	 *
	 */
	...
	/**
	 * Checks if the current token has the given kind. If so, the current token is consumed and returned. If not, a
	...
	/**
	 * Checks if the current token has one of the given kinds. If so, the current token is consumed and returned. If
	 * not, a SyntaxException is thrown.
	 * 
	...
	private Token match(Kind... kinds) throws SyntaxException {
		...
		throw new SyntaxException(
				"The expected token kind " + t.kind + " is not in the expected kinds" + Arrays.toString(kinds));
	}
